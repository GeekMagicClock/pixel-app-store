...
local function dbg(msg)
  print("[basketball_schedule] " .. tostring(msg or ""))
end
...
local function teams_cache_key(prefix)
  return string.format("basketball_schedule.%s.%s.%s", tostring(prefix), tostring(SPORT), tostring(LEAGUE))
end
