...
local LEAGUE = tostring(data.get("baseball_scoreboard.league") or "mlb")
local TEAM = string.upper(tostring(data.get("baseball_scoreboard.team") or data.get("game_summary.team") or data.get("sports.default_team") or ""))
local TEAM_ID = tostring(data.get("baseball_scoreboard.team_id") or data.get("game_summary.team_id") or data.get("sports.default_team_id") or "")
local EVENT_ID = tostring(data.get("baseball_scoreboard.event_id") or data.get("game_summary.event_id") or "")
local SCOREBOARD_ONLY = tostring(data.get("baseball_scoreboard.scoreboard_only") or data.get("game_summary.scoreboard_only") or ((SPORT == "soccer" and EVENT_ID == "") and "1" or "0")) == "1"
local USE_DATE_FILTER = tostring(data.get("baseball_scoreboard.use_date_filter") or data.get("game_summary.use_date_filter") or "1") ~= "0"
local AUTO_PAGE = tostring(data.get("baseball_scoreboard.auto_page") or data.get("game_summary.auto_page") or "1") ~= "0"
local ROTATE_SEC = num_setting("baseball_scoreboard.rotate_sec", num_setting("game_summary.rotate_sec", nil))
...
local __boot_ms = tonumber(data.get("baseball_scoreboard.boot_splash_ms") or data.get("app.boot_splash_ms") or 1200) or 1200
