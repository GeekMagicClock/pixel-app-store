...
local APP_NAME = tostring(data.get("football_schedule.app_name") or "Football Schedule")
...
local __boot_ms = tonumber(data.get("football_schedule.boot_splash_ms") or data.get("app.boot_splash_ms") or 5000) or 5000
if __boot_ms < 0 then __boot_ms = 0 end
local __boot_name = tostring(data.get("football_schedule.app_name") or "Football Schedule")
