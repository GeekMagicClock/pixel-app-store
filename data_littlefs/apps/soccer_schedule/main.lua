...
local APP_NAME = tostring(data.get("soccer_schedule.app_name") or "Soccer Schedule")
...
local __boot_ms = tonumber(data.get("soccer_schedule.boot_splash_ms") or data.get("app.boot_splash_ms") or 1200) or 1200
if __boot_ms < 0 then __boot_ms = 0 end
local __boot_name = tostring(data.get("soccer_schedule.app_name") or "Soccer Schedule")
