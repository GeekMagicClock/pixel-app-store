...
local __boot_ms = tonumber(data.get("auto_snake.boot_splash_ms") or data.get("app.boot_splash_ms") or 1200) or 1200
if __boot_ms < 0 then __boot_ms = 0 end
local __boot_name = tostring(data.get("auto_snake.app_name") or "Auto Snake")
