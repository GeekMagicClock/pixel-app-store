...
local TEAM = string.upper(tostring(data.get("hockey_schedule.team") or data.get("sports.default_team") or ""))
local TEAM_ID = tostring(data.get("hockey_schedule.team_id") or data.get("sports.default_team_id") or "")
local COUNT = tonumber(data.get("hockey_schedule.count") or 3) or 3
local SCHEDULE_LIMIT = math.max(1, tonumber(data.get("hockey_schedule.schedule_limit") or 8) or 8)
local SCORE_DAYS = math.max(1, tonumber(data.get("hockey_schedule.score_days") or 7) or 7)
local INCLUDE_LAST_RESULT = tostring(data.get("hockey_schedule.include_last_result") or "1") ~= "0"
local ROTATE_MS = tonumber(data.get("hockey_schedule.rotate_ms") or 4000) or 4000
local TTL_MS = tonumber(data.get("hockey_schedule.ttl_ms") or 10 * 60 * 1000) or (10 * 60 * 1000)
...
local __boot_ms = tonumber(data.get("hockey_schedule.boot_splash_ms") or data.get("app.boot_splash_ms") or 1200) or 1200
