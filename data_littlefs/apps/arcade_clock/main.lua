...
function app.render_fb(fb)
  ...
  fb:text_box(2, 24, 34, 8, "CREDIT 01", C_RED, FONT_UI, 8, "left", true)
  fb:text_box(36, 24, 26, 8, string.format("%s %02d", MONTHS[month], tonumber(t.day or 1) or 1), C_BLUE, FONT_UI, 8, "right", true)
end
